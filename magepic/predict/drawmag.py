...
# 绘制对角线（y = x）
ax.plot([-0.2, 5.5], [-0.2, 5.5], 'k--', alpha=0.4, zorder=3)
...
# 设置坐标轴标签
ax.set_xlabel('True Magnitude', fontsize=11, color='#585858',fontweight='bold')
ax.set_ylabel('Predicted Magnitude', fontsize=11,color='#585858', fontweight='bold')
...
# 显示图形
plt.savefig('mag.png', dpi=600, bbox_inches='tight')
plt.show()